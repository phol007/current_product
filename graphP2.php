...
<script>
                  ...
                  all += "<div class='table-responsive'><table width='100%'>";
                  all += "<tr align='center'><th>คิว</th><th width='10%'>ทะเบียนรถ</th><th>ยี่ห้อรถ</th><th>เวลา</th><th width='10%'>จำนวนสินค้า/รายการ</th><th>มูลค่า pickup</th>";
                  all += "<th>มูลค่าเช็คของ</th><th>มูลค่าออกบิล</th><th>ยกเลิกสินค้า</th></tr>"

                  while(i<count){
                    if(data[i].isCancel == 0){ isCan = "<font color='green'>สมบูรณ์</font>"; sty=""; c="<a href='testTable.php?qId="+data[i].qId+"' data-toggle='modal' data-target='#myModal'>"+ data[i].carLicence + 
                    "</a>";}
                    else if(data[i].isCancel == 1){ isCan = "<font color='#fff'>ยกเลิกคิว</font> "; sty = "style='background:red; color:#fff;'"; c=data[i].carLicence;}
                    ...
                    all += "<tr "+sty+"><td align='center'>"+data[i].qId+"</td><td align='right'><div class=id"+i+">"+ c +"</div> </td><td align='right'>"+ data[i].carBrand +"</td><td align='right'>"+time+"</td><td align='right'>"+ data[i].numberOfItem+
