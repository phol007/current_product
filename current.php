...
<script>
  function select_time(time){
   window.location="current.php?time="+time.value;    
              ...
              <div class="ui-block-d">
                <div class="menu2"><p></p><p></p>
                <p><font size="+1" color="#000000">isCancel (ยกเลิกคิว)</font></p>
                <div id="cancel"></div>
                </div>
              </div>
    			...
    			<div class="ui-grid-a ui-responsive">
      				...
      				<div class="ui-block-a">
        				<div class="menuNotsuscess">
  						    <table width="100%"><tr><td><font  color="#000000"><h4>ยอดการขนของ</h4></font><p></p></td></tr><tr><td align='right'>
                  <div id="pickAmount"></div>
      				...
      				<div class="ui-block-b">
        				<div class="menuNotsuscess2">
  						  <table width="100%"><tr><td><font  color="#000000"><h4>ยอดสินค้าที่ยังไม่ออกบิล</h4></font><p></p></td></tr><tr><td align='right'>
                <div id="itemCancel"></div>
                </td></tr></table>
  						  </div>
      				</div>
          ...
          <div class="ui-grid-a ui-responsive">
              ...
              <div class="ui-block-a">
                <div class="menuNotsuscess">
                  <table width="100%"><tr><td><font  color="#000000"><h4>ยอดเช็คของ</h4></font><p></p></td></tr><tr><td align='right'>
                  <div id="checkoutAmount"></div>
                  </td></tr></table>
                </div>
              </div>
              ...
              <div class="ui-block-b">
                <div class="menuNotsuscess">
                <table width="100%"><tr><td><font  color="#000000"><h4>ยอดขายสุทธิ</h4></font><p></p></td></tr><tr><td align='right'>
                <div id="Sale"></div>
                </td></tr></table>
                </div>
              </div>
